...
# IMPORTANT: Run from Superpowers-zh directory so local dev skills are available
...
if grep -q '"name":"Skill".*"skill":"superpowers-zh:subagent-driven-development"' "$SESSION_FILE"; then
