...
mkdir -p "$HOME/.config/opencode/Superpowers-zh"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/Superpowers-zh/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/Superpowers-zh/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/Superpowers-zh/.opencode/plugins"
cp "$REPO_ROOT/.opencode/plugins/Superpowers-zh.js" "$HOME/.config/opencode/Superpowers-zh/.opencode/plugins/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugins"
ln -sf "$HOME/.config/opencode/Superpowers-zh/.opencode/plugins/Superpowers-zh.js" \
       "$HOME/.config/opencode/plugins/Superpowers-zh.js"
...
echo "Plugin installed to: $HOME/.config/opencode/Superpowers-zh/.opencode/plugins/Superpowers-zh.js"
echo "Plugin registered at: $HOME/.config/opencode/plugins/Superpowers-zh.js"
