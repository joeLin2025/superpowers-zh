...
为 Gemini CLI 打造的“超能力”技能包，实现自动引导和进阶开发工作流。
...
```bash
git clone https://github.com/your-repo/gemini-skills.git
cd gemini-skills
./install.sh
```

安装完成后，重新启动 `gemini` CLI 即可。
...
一旦安装，Gemini 在处理你的请求前会：
1. 阅读全局 `GEMINI.md` 中的引导词。
